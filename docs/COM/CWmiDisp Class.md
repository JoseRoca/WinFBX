...
| Parameter  | Description |
| ---------- | ----------- |
| *cbsQuery* | Required. A string that contains the text of the query. This parameter cannot be blank. |
...
| Parameter  | Description |
| ---------- | ----------- |
| *cbsObjectPath* | A string that contains the object path of the object to retrieve. If this value is empty, the empty object that is returned can become a new class. |
...
| Parameter  | Description |
| ---------- | ----------- |
| *cbsClass* | Required. A string that contains the name of the class for which instances are desired. This parameter cannot be blank. |
